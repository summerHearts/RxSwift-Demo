//
//  RxSwiftTwoWayBindController.swift
//  RxSwift-Demo
//
//  Created by Kenvin on 2017/8/8.
...
class RxSwiftTwoWayBindController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        textfield.rx.text.orEmpty.bind(to: label.rx_text).disposed(by: disposeBag)
